...
var STACK_BASE = 16750624, STACKTOP = STACK_BASE, STACK_MAX = 21993504, DYNAMIC_BASE = 21993504, DYNAMICTOP_PTR = 16749632;
...
var wasmBinaryFile = "SalfaHTML5.wasm";
...
if (!ENVIRONMENT_IS_PTHREAD) {
  memoryInitializer = "SalfaHTML5.js.mem";
}

var tempDoublePtr;

if (!ENVIRONMENT_IS_PTHREAD) tempDoublePtr = 16750608;
...
var __main_thread_futex_wait_address = 16750592;
...
var PThread = {
  ...
  initMainThreadBlock: function () {
    ...
    PThread.mainThreadBlock = 16749808;
    ...
    for (var i = 0; i < numWorkers; ++i) {
      ...
      (function (worker) {
        worker.onmessage = function (e) {
          ...
          } else if (cmd === "message") { // Se agrega este comando para enviar mensajes al padre FOX
            document.defaultView.parent.postMessage(d["text"], '*');
          }
          else if (cmd === "alert") {
  ...
  createNewWorkers: function (numWorkers) {
    if (typeof SharedArrayBuffer === "undefined") return [];
    var pthreadMainJs = "SalfaHTML5.worker.js";
...
var ___tm_timezone = (stringToUTF8("GMT", 16749712, 4), 16749712);
...
var _EmscriptenGetMyGameMode = Module["_EmscriptenGetMyGameMode"] = function () {
  assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
  assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
  return Module["asm"]["_EmscriptenGetMyGameMode"].apply(null, arguments);
};
...
var _bind_web_events = Module["_bind_web_events"] = function () {
  assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
  assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
  return Module["asm"]["_bind_web_events"].apply(null, arguments);
};
...
var _getMessageC = Module["_getMessageC"] = function () {
  assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
  assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
  return Module["asm"]["_getMessageC"].apply(null, arguments);
};
...
var _request_do_fullscreen_callback = Module["_request_do_fullscreen_callback"] = function () {
  assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
  assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
  return Module["asm"]["_request_do_fullscreen_callback"].apply(null, arguments);
};

var _returnSomeValue = Module["_returnSomeValue"] = function () {
  assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
  assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
  return Module["asm"]["_returnSomeValue"].apply(null, arguments);
};
